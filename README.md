...
1. Download and extract the repository files: Use the command "git clone https://github.com/HaiderFlorez/solana-pumpfun-sniper-bot" or click the green "Code" button and select "Download ZIP".
